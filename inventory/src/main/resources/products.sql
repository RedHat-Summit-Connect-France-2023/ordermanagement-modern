...
insert into products (itemId, link, location, quantity, price,name,description, category) values (329299, '/imgs/Vortex_Tumbler.jpg', 'Raleigh', 736, 100,'16 oz. Vortex Tumbler','Vortex Tumbler','bottle');
...
insert into products (itemId, link, location, quantity, price,name,description, category) values (444436, '/imgs/Red_Fedora.jpg', 'Tokyo', 230, 3,'Red Fedora','Red Fedora','hat');
